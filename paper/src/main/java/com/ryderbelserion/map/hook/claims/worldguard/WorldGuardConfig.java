...
public final class WorldGuardConfig extends AbstractConfig {
    ...
    @Key("settings.claim.regions.blacklist")
    @Comment("A list of regions that will not show up on the map.")
    public static List<@NotNull String> BLACKLISTED_REGIONS = new ArrayList<>() {{
        add("example_region");
    }};
